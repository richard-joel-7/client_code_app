...
export const Button = ({ children, className, variant = "primary", ...props }) => {
    const variants = {
        primary: "bg-primary text-dark-900 hover:bg-primary/90 shadow-[0_0_15px_rgba(0,229,255,0.5)] hover:shadow-[0_0_25px_rgba(0,229,255,0.7)] font-bold",
        secondary: "bg-white/10 text-white hover:bg-white/20 border border-white/10 backdrop-blur-sm",
        outline: "border border-primary text-primary hover:bg-primary/10 shadow-[0_0_10px_rgba(0,229,255,0.2)]",
